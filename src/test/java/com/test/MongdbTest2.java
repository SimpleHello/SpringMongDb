...
import com.demo.test.test1.Cx01;
import com.mongodb.BasicDBObject;

@RunWith(SpringJUnit4ClassRunner.class)
@WebAppConfiguration
@ContextConfiguration(locations = "classpath:conf/applicationContext.xml")
public class MongdbTest2 {
	...
	public void insert() throws ParseException {
		List<EqLevelEntity>  demoList = Cx01.getEqLevel();
		for(EqLevelEntity entity:demoList){
			mongoTemplate.save(entity, "admin02");
		}
	}
